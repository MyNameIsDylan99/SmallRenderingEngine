...
namespace OpenGL
{
    public partial class Gl
    {
        ...
        {
            Delegates.glSamplerParameterf(sampler, (OpenGL.TextureParameterName)pname, param);
        }
        ...
        {
            Delegates.glSamplerParameteri(sampler, (OpenGL.TextureParameterName)pname, param);
        }
        ...
        {
            Delegates.glSamplerParameterfv(sampler, (OpenGL.TextureParameterName)pname, @params);
        }
        ...
        {
            Delegates.glSamplerParameteriv(sampler, (OpenGL.TextureParameterName)pname, @params);
        }
