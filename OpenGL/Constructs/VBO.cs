...
namespace OpenGL
{
        ...
        where T : struct
    {
        ...
        private static readonly Dictionary<Type, int> TypeComponentSize = new Dictionary<Type, int>()
        {
            ...
            [typeof(double)] = 1,
            [typeof(Vector2)] = 2,
            [typeof(ObjLoader.Loader.Data.VertexData.Texture)] = 2,
            [typeof(Vector3)] = 3,
            [typeof(Vertex)] = 3,
            [typeof(Normal)] = 3,
            [typeof(Vector4)] = 4,
        ...
        private static readonly Dictionary<Type, VertexAttribPointerType> TypeAttribPointerType = new Dictionary<Type, VertexAttribPointerType>()
        {
            ...
            [typeof(ObjLoader.Loader.Data.VertexData.Texture)] = VertexAttribPointerType.Float,
            [typeof(Vector3)] = VertexAttribPointerType.Float,
            [typeof(Vertex)] = VertexAttribPointerType.Float,
            [typeof(Normal)] = VertexAttribPointerType.Float,
